...
Set "Skin14=%CD%\Extras Disc\FlashSM\prep\skins\CleanupHM"
Set "Skin15=%CD%\Extras Disc\FlashSM\prep\skins\CleanupSM"
Set "Skin16=%CD%\Extras Disc\FlashSM\prep\skins\TSOPFlash"
Set "Skin17=%CD%\Installer Variants\XBHDM Build\C\installer\skins\Softmod"
